...
class SeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seed" do
    assert_difference('Seed.count') do
      post seeds_url, params: { seed: { description: @seed.description, image: @seed.image, latin_title: @seed.latin_title, title: @seed.title, usda: @seed.usda } }
    end
  ...
  test "should update seed" do
    patch seed_url(@seed), params: { seed: { description: @seed.description, image: @seed.image, latin_title: @seed.latin_title, title: @seed.title, usda: @seed.usda } }
